...
public class Player : MonoBehaviour, ICharacter
{
    ...
    {
        ManaLeft -= playedCard.CurrentResourceCost;
    ...
    {
        Debug.Log(ManaLeft);
        Debug.Log(playedCard.CurrentResourceCost);
        ManaLeft -= playedCard.CurrentResourceCost;
    ...
    public void HighlightPlayableCards(bool removeAllHighlights = false)
    {
        ...
        foreach (CardLogic cl in hand.CardsInHand)
        {
            ...
            if (g!=null)
                g.GetComponent<OneCardManager>().CanBePlayedNow = (cl.CurrentResourceCost <= ManaLeft) && !removeAllHighlights;
        }
        ...
        foreach (CreatureLogic crl in table.CreaturesOnTable)
        {
            ...
            if(g!= null)
                g.GetComponent<OneUnitManager>().CanAttackNow = (crl.AttacksLeftThisTurn > 0) && !removeAllHighlights;
        }
